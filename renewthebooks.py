...
#续借后，借阅时间为当前时间，应还时间为借阅时间加续借的天数（默认为30)
...
#登陆信息
#data=b'T1=1100801316&xm=&tday1=26360&B1=%b5%c7%c2%bd&T3=921913'
...
#续借信息
print ('正在续借所有书籍...')
#data1=b'netxj%5b%5d=00992810%2F%2F5%2F%2F-1&T1=1100801316&Submit=%d0%f8%bd%e8%d1%a1%d6%d0%cd%bc%ca%e9'
